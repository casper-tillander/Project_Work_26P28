...
- generates C files for micro controller
"""
...
MODEL_PATH = PROJECT_ROOT / "outputs_regressor" / "regressor_model.pkl"
FEATURE_NAMES_PATH = PROJECT_ROOT / "outputs_regressor" / "regressor_feature_names.json"
TARGET_NAMES_PATH = PROJECT_ROOT / "outputs_regressor" / "regressor_target_names.json"

HEADER_PATH = PROJECT_ROOT / "c" / "rf_regressor_model.h"
SOURCE_PATH = PROJECT_ROOT / "c" / "rf_regressor_model.c"
